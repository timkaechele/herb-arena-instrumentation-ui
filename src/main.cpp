...
int main(int argc, char **argv)
{
    ...
    SDL_Window* window = SDL_CreateWindow("Herb Arena Instrumentation", (int)(1280 * main_scale), (int)(720 * main_scale), window_flags);
    if (window == nullptr)
    {
    ...
    ImFont* font = io.Fonts->AddFontFromFileTTF("./assets/fira_mono.ttf");
